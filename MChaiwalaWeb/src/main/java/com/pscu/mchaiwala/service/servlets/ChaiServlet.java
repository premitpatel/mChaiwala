...
package com.pscu.mchaiwala.service.servlets;
...
public class ChaiServlet extends HttpServlet {
     ...
     * 
     */
    private static final long serialVersionUID = -6119370410720487529L;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // out.println(" Employee Name: " + employeeId);
        // out.println("  </BODY>");
        // out.println("</HTML>");
        // out.flush();
        // out.close();

        response.sendRedirect("/MChaiwalaWeb/ChaiPayment.jsp?username=" + username + "&amount=" + amount + "&vendorid=" + vendorid);
    }
